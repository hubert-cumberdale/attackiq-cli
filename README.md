...
- Recommended tooling:
  ...
  - `python3 scripts/build_enterprise_package.py --source-ref vX.Y.Z --output-dir <dir>` builds
    credential-free enterprise package promotion artifacts from a public release tag.
  - `python3 scripts/verify_enterprise_package.py <dir>` verifies the package manifest,
    checksums, safe artifact names, and wheel public-safety status before or after Artifactory.
