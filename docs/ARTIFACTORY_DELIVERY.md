...
python3 scripts/build_enterprise_package.py \
  --source-ref v0.1.19 \
  --output-dir /tmp/attackiq-cli-enterprise-package-v0.1.19
...
- records upload filenames, SHA256 values, sizes, and target paths
...
```bash
python3 scripts/verify_enterprise_package.py /tmp/attackiq-cli-artifactory-download-v0.1.19
```
