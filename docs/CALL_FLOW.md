...
## Code references
- `src/attackiq_cli/cli.py` -> `call`
- `src/attackiq_cli/cli.py` -> `handle_response`
- `src/attackiq_cli/cli.py` -> `coerce_params`
...
- `src/attackiq_cli/services.py` -> `load_service_context`
- `src/attackiq_cli/services.py` -> `ensure_auth`
