...
- [Observable field mappings](BACKUP_DOMAIN_INTAKE_OBSERVABLE_FIELD_MAPPINGS.md): selected as the
  next `needs-redaction` candidate for fixture, redaction, manifest, and retention review; not
  enabled in CLI defaults.
