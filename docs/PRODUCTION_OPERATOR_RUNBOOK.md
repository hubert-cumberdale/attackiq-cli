...
production-ready release line is `v0.1.25` for standard documented CLI workflows. Continue to use
...
evidence verifier only checks local evidence consistency; enterprise signing trust-root
...
verified subject digests recorded in the enterprise release system.
