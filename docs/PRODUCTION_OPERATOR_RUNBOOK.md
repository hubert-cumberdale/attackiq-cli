...
production-ready release line is `v0.1.25` for standard documented CLI workflows until a later
candidate is tagged, published, and promoted in `docs/STATE.md`. Continue to use
