...
production-ready release line is `v0.1.18` for standard documented CLI workflows. Continue to use
...
```bash
python3 scripts/verify_enterprise_package.py /tmp/attackiq-cli-enterprise-package-v0.1.18
```
