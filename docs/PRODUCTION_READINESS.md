...
Current release status: `v0.1.18` is production-ready for standard documented CLI work and
credential-free enterprise package promotion as of 2026-05-25 after public-safety cleanup, public
mirror validation, package promotion artifact validation, offline package verification, package provenance, local
quality gates, Node 24-compatible GitHub Actions, release governance checks, and package guard
updates. Continue to require
