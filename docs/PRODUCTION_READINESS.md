...
Current release status: `v0.1.19` is production-ready for standard documented CLI work and
...
Artifactory promotion evidence generation, local quality gates, Node 24-compatible GitHub Actions,
release governance checks, and package guard updates. Continue to require
