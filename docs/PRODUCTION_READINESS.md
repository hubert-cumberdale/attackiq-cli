...
Current release status: `v0.1.22` is production-ready for standard documented CLI work and
credential-free enterprise package promotion as of 2026-05-26 after public-safety cleanup, public
mirror validation, package promotion artifact validation, checked install constraints, fail-closed constraints verification, offline
package verification, package provenance, Artifactory promotion evidence generation,
signing/attestation evidence generation, local quality
gates, Node 24-compatible GitHub Actions, release governance checks, and package guard updates.
Continue to require
