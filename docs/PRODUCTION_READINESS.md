...
Current release status: `v0.1.14` is production-ready for standard documented CLI work as of
2026-05-22 after public-safety cleanup, public mirror dry-run validation, local quality gates,
release governance checks, and package guard updates. Continue to require workflow-specific
approval for destructive, high-volume, custom-scenario, restore/apply, or tenant-data-heavy
activity.
...
2. Audit: run dependency audit, security/redaction review, public-safety, public-mirror, and docs
   integrity checks.
