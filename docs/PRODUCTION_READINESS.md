...
Current release status: `v0.1.25` is prepared as the post-#75 release candidate for standard
documented CLI work and credential-free enterprise package promotion as of 2026-05-29 after
public-safety cleanup, public mirror validation, package promotion artifact validation, checked
install constraints, fail-closed constraints verification, offline package verification, SBOM and
dependency-integrity generation, package provenance, Artifactory promotion evidence generation,
signing/attestation evidence generation, enterprise evidence verification, local quality gates,
Node 24-compatible GitHub Actions, release governance checks, CI/local quality-gate parity, and
package guard updates.
Continue to require
...
```bash
mkdir -p /tmp/attackiq-cli-enterprise-package-v0.1.25/local-wheelhouse
python -m pip download \
  --dest /tmp/attackiq-cli-enterprise-package-v0.1.25/local-wheelhouse \
  -c /tmp/attackiq-cli-enterprise-package-v0.1.25/constraints.txt \
  /tmp/attackiq-cli-enterprise-package-v0.1.25/attackiq_cli-0.1.25-py3-none-any.whl
python -m venv /tmp/attackiq-cli-enterprise-package-v0.1.25/install-venv
/tmp/attackiq-cli-enterprise-package-v0.1.25/install-venv/bin/python -m pip install \
  --no-index \
  --find-links /tmp/attackiq-cli-enterprise-package-v0.1.25/local-wheelhouse \
  -c /tmp/attackiq-cli-enterprise-package-v0.1.25/constraints.txt \
  attackiq-cli==0.1.25
/tmp/attackiq-cli-enterprise-package-v0.1.25/install-venv/bin/attackiq --version
/tmp/attackiq-cli-enterprise-package-v0.1.25/install-venv/bin/attackiq config validate
```
...
repository permission, artifact signing, attestation publication, or trust-root verification.
