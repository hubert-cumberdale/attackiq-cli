...
2. Promote and verify enterprise packages from public release tags with constraints, checksum, manifest, and provenance evidence.
...
- Enterprise package promotion artifacts build and verify from the public tag with
  constraints/checksum/manifest/provenance evidence and no registry credentials.
