...
2. Promote enterprise packages from public release tags with checksum and manifest evidence.
...
- Enterprise package promotion artifacts build from the public tag and include checksum/manifest
  evidence without registry credentials.
