...
- `src/attackiq_cli/cli.py` for top-level app registration and global options
- the relevant `src/attackiq_cli/cli_*.py` command-family module, such as `cli_call.py`,
  `cli_export.py`, `cli_join.py`, `cli_tui.py`, `cli_scenarios.py`, `cli_assessments.py`, or
  `cli_tests.py`
