...
- Current production-ready release: `v0.1.18`.
- Release note: `v0.1.18` updates GitHub Actions to Node 24-compatible official action majors,
  removing the Node 20 deprecation warning from CI while preserving the enterprise package
  provenance workflow.
- Previous release: `v0.1.17` added offline enterprise package provenance for generated package
  directories.
...
tagged ref, such as `python3 scripts/check_public_mirror.py --ref v0.1.18`.
