...
- Current production-ready release: `v0.1.22`.
- Release note: `v0.1.22` adds fail-closed enterprise package verification for required
  install constraints and makes Artifactory/signing evidence require the checked `constraints.txt`
  artifact.
- Previous release: `v0.1.21` packaged `constraints.txt` as a checked enterprise package artifact,
  recorded it in package provenance, and included it in Artifactory promotion and signing evidence.
...
- Build validated enterprise package promotion artifacts from public release tags without storing
  ...
  evidence for operator-owned uploads, and create credential-free signing/attestation evidence for
...
tagged ref, such as `python3 scripts/check_public_mirror.py --ref v0.1.22`.
