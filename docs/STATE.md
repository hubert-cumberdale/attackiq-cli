...
- Current production-ready release: `v0.1.17`.
- Release note: `v0.1.17` adds offline enterprise package provenance for generated package
  directories, including source/manifest agreement, wheel digest and size data, and wheel
  dependency metadata validation.
- Previous release: `v0.1.16` added independent offline package verification for generated or
  Artifactory-downloaded package directories.
...
- Build validated enterprise package promotion artifacts from public release tags without storing
  registry credentials, generate offline package provenance/dependency inventory, and verify
  generated or downloaded package artifact directories before promotion or install.
...
tagged ref, such as `python3 scripts/check_public_mirror.py --ref v0.1.17`.
...
The script does not upload to Artifactory, accept registry credentials, sign artifacts, or attach
package artifacts to the public GitHub release. Operators promote the generated wheel, checksums,
manifest, and provenance through their approved enterprise package workflow outside this repository.
