...
- Current production-ready release: `v0.1.15`.
- Release note: `v0.1.15` adds credential-free enterprise package promotion tooling that builds a
  validated wheel from a public release tag, writes `SHA256SUMS`, and records an
  `ENTERPRISE_PROMOTION_MANIFEST.json` without accepting Artifactory credentials.
- Previous release: `v0.1.14` added a validated no-history public mirror workflow for publishing a
...
tagged ref, such as `python3 scripts/check_public_mirror.py --ref v0.1.15`.
