...
- Current production-ready release: `v0.1.23`.
- Release note: `v0.1.23` aligns generated Artifactory and signing evidence checklists with
  fail-closed `--require-constraints` package verification.
- Previous release: `v0.1.22` added fail-closed enterprise package verification for required
  install constraints and made Artifactory/signing evidence require the checked `constraints.txt`
  artifact.
...
tagged ref, such as `python3 scripts/check_public_mirror.py --ref v0.1.23`.
