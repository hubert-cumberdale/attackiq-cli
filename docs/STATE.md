...
- Current production-ready release: `v0.1.21`.
- Release note: `v0.1.21` packages `constraints.txt` as a checked enterprise package artifact,
  records it in package provenance, and includes it in Artifactory promotion and signing evidence.
- Previous release: `v0.1.20` added credential-free signing and attestation evidence generation for
...
tagged ref, such as `python3 scripts/check_public_mirror.py --ref v0.1.21`.
