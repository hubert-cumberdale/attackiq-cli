...
- Current production-ready release: `v0.1.20`.
- Release note: `v0.1.20` adds credential-free signing and attestation evidence generation for
  verified enterprise package directories, including signing subjects, SHA256 values, expected
  detached signature files, expected attestation files, and predicate requirements.
- Previous release: `v0.1.19` added credential-free Artifactory promotion evidence generation for
  verified enterprise package directories.
...
- Build validated enterprise package promotion artifacts from public release tags without storing
  ...
  generated or downloaded package artifact directories before promotion or install, create
  credential-free Artifactory promotion evidence for operator-owned uploads, and create
  credential-free signing/attestation evidence for enterprise signing workflows.
...
tagged ref, such as `python3 scripts/check_public_mirror.py --ref v0.1.20`.
...
Operators promote the generated wheel, checksums, manifest, provenance, optional promotion
evidence, and optional signing evidence through their approved enterprise package workflow outside
this repository.
