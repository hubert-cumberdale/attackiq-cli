...
- Canonical provider contract source: tracked in `docs/AIQ_ASSIST_MCP_PROVIDER_SOURCE.json`;
  currently pending. Documenting it is necessary but does not unlock CLI/TUI consumption without
  explicit consumption approval and adapter mock-test evidence.
