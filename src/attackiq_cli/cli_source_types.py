...
from attackiq_cli.exporter import SOURCE_TYPE_FIELD_ORDER, write_csv_records, write_json
...
from attackiq_cli.services import list_source_types as svc_list_source_types
from attackiq_cli.spec import SpecIndex

console = Console()

source_types_app = typer.Typer(
    help="Source type commands.",
...
def list_source_types(
    ...
    records: list[dict[str, Any]] = build_source_type_summary_records(source_types)
    if fmt == "csv":
        if output is None:
