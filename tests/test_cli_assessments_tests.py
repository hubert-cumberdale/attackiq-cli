...
def test_assessments_list_uses_services_list_helper(monkeypatch) -> None:
    ...
    monkeypatch.setattr(cli, "svc_list_assessments", _svc_list_assessments)
...
def test_assessments_show_uses_services(monkeypatch) -> None:
    ...
    monkeypatch.setattr(cli, "fetch_assessment_detail", _fetch_assessment_detail)
...
def test_tests_list_uses_services_list_helper(monkeypatch) -> None:
    ...
    monkeypatch.setattr(cli, "ensure_auth", lambda *_args, **_kwargs: [])
    monkeypatch.setattr(cli.SpecIndex, "from_file", lambda *_args, **_kwargs: DummySpecIndex())
    monkeypatch.setattr(cli, "svc_list_tests", _svc_list_tests)
...
def test_tests_show_uses_services(monkeypatch) -> None:
    ...
    monkeypatch.setattr(cli, "fetch_test_detail", _fetch_test_detail)
