...
import attackiq_cli.cli_asset_groups as cli_asset_groups
...
def test_asset_groups_list_passes_schema_backed_filters(monkeypatch):
    ...
    monkeypatch.setattr(cli_asset_groups, "load_config_or_exit", lambda: CliConfig())
    monkeypatch.setattr(
        cli_asset_groups,
        "resolve_base_url",
    ...
    monkeypatch.setattr(cli_asset_groups, "ensure_auth", lambda *_args, **_kwargs: [])
    monkeypatch.setattr(
        cli_asset_groups.SpecIndex,
        "from_file",
        lambda *_args, **_kwargs: DummySpecIndex(),
    )
    monkeypatch.setattr(cli_asset_groups, "svc_list_asset_groups", _svc_list_asset_groups)
    monkeypatch.setattr(cli_asset_groups, "write_json", _write_json)
    ...
    filters = cast(cli_asset_groups.AssetGroupFilters, captured["filters"])
...
def test_asset_groups_show_fetches_asset_group_detail(monkeypatch):
    ...
    monkeypatch.setattr(cli_asset_groups, "fetch_asset_group_detail", _fetch_asset_group_detail)
    monkeypatch.setattr(cli_asset_groups, "write_json", _write_json)
