...
def _patch_common(monkeypatch) -> None:
    monkeypatch.setattr(cli_platform_api, "load_config_or_exit", lambda: CliConfig())
    monkeypatch.setattr(
        cli_platform_api,
        "resolve_base_url",
...
def test_platform_api_parity_compares_scenario_ids(monkeypatch) -> None:
    ...
    monkeypatch.setattr(cli_platform_api, "svc_list_scenarios", _svc_list_scenarios)
...
def test_platform_api_parity_compares_assets_with_supported_filters(monkeypatch) -> None:
    ...
    _patch_common(monkeypatch)
    monkeypatch.setattr(cli_platform_api, "svc_list_assets", _svc_list_assets)
