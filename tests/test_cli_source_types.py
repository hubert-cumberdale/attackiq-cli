...
import attackiq_cli.cli_source_types as cli_source_types
...
def test_source_types_list_passes_required_filters(monkeypatch):
    ...
    monkeypatch.setattr(cli_source_types, "load_config_or_exit", lambda: CliConfig())
    monkeypatch.setattr(
        cli_source_types,
        "resolve_base_url",
    ...
    monkeypatch.setattr(cli_source_types, "ensure_auth", lambda *_args, **_kwargs: [])
    monkeypatch.setattr(
        cli_source_types.SpecIndex,
        "from_file",
        lambda *_args, **_kwargs: DummySpecIndex(),
    )
    monkeypatch.setattr(cli_source_types, "svc_list_source_types", _svc_list_source_types)
    monkeypatch.setattr(cli_source_types, "write_json", _write_json)
    ...
    filters = cast(cli_source_types.SourceTypeFilters, captured["filters"])
