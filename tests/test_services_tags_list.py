...
import attackiq_cli.services_tags as services_tags
...
def test_list_tags_autopaginates_with_filters(monkeypatch) -> None:
    ...
    monkeypatch.setattr(services_tags, "build_client", lambda *_args, **_kwargs: ClientManager())
    monkeypatch.setattr(services_tags, "paginate_results", _paginate_results)
