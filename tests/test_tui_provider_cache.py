...
from attackiq_cli.tui import ResultsViewMode, TuiDataProvider, TuiOptions
...
def test_provider_caches_scenarios_pages(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_scenarios_page", _fake_fetch)
...
def test_provider_caches_scenario_details(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_scenario_detail", _fake_fetch)
...
def test_provider_caches_results_list(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_results_list", _fake_fetch)
...
def test_provider_caches_phase_records(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_phase_results", _fake_phase_results)
    monkeypatch.setattr("attackiq_cli.tui.fetch_phase_logs", _fake_phase_logs)
...
def test_provider_clear_results_cache_forces_refetch(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_results_list", _fake_results)
    monkeypatch.setattr("attackiq_cli.tui.fetch_phase_results", _fake_phase_results)
    monkeypatch.setattr("attackiq_cli.tui.fetch_phase_logs", _fake_phase_logs)
...
def test_provider_cache_ttl_expires_entries(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_scenarios_page", _fake_fetch)
    monkeypatch.setattr("attackiq_cli.tui.time.monotonic", lambda: now[0])
...
def test_provider_cache_stats_prune_expired_entries(monkeypatch):
    ...
    monkeypatch.setattr(
        "attackiq_cli.tui.fetch_scenarios_page",
        lambda *_args, **_kwargs: ([{"id": "scenario-1"}], False),
    )
    monkeypatch.setattr(
        "attackiq_cli.tui.fetch_scenario_detail",
        lambda *_args, **_kwargs: {"id": "scenario-1"},
    )
    monkeypatch.setattr(
        "attackiq_cli.tui.fetch_results_list",
        lambda *_args, **_kwargs: ([{"id": "result-1"}], False),
    )
    monkeypatch.setattr(
        "attackiq_cli.tui.fetch_phase_results",
        lambda *_args, **_kwargs: [{"result_summary_id": "r-1"}],
    )
    monkeypatch.setattr(
        "attackiq_cli.tui.fetch_phase_logs",
        lambda *_args, **_kwargs: [{"result_summary_id": "r-1"}],
    )
    monkeypatch.setattr("attackiq_cli.tui.time.monotonic", lambda: now[0])
...
def test_provider_caches_assessments_pages_and_details(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_assessments_page", _fake_fetch_page)
    monkeypatch.setattr("attackiq_cli.tui.fetch_assessment_detail", _fake_fetch_detail)
...
def test_provider_caches_templates_pages_and_details(monkeypatch):
    ...
    monkeypatch.setattr("attackiq_cli.tui.fetch_templates_page", _fake_fetch_page)
    monkeypatch.setattr("attackiq_cli.tui.fetch_template_detail", _fake_fetch_detail)
